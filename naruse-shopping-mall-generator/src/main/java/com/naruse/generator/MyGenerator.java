...
public class MyGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\NaruseGithubProject\\naruse-shopping-mall-parent\\naruse-shopping-mall-service\\naruse-shopping-ums\\src\\main\\java");
        gc.setAuthor("Naruse Shinji");
        ...
        dsc.setUrl("jdbc:mysql://192.168.80.130:3306/naruse-shopping-mall?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("yan1210calvin");
